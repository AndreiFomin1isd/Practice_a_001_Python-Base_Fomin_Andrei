...
- [Индексы и срезы](#индексы-и-срезы)
- [Функции](#функции)
- [Геометрические задачи](#геометрические-задачи)
- [Простые задачи](#простые-задачи)
- [Консольные меню](#консольные-меню)
- [Графические интерфейсы (Tkinter)](#графические-интерфейсы-tkinter)
